  ...
  Future<void> updateDetails({required String photoUrl}) async {
    try {
      await FirebaseFirestore.instance
          .collection('profiles')
          .doc(profile.id)
          .update({'vehicle.registrationUrl': photoUrl});
                ...
                children: [
                  Icon(
                    registrationUrl != ''
                        ? Icons.check_circle
                        : Icons.upload_file,
                    color: registrationUrl != '' ? Colors.green : Colors.grey,
                  ),
                  SizedBox(width: 12),
                  Expanded(
                    child: Center(
                  ...
                  children: [
                    TextButton(
                      onPressed: isLoading
                          ? null
                          : () async {
                              if (registrationUrl == '' && pickedFile == null) {
                                selectFile();
                      ...
                      style: TextButton.styleFrom(
                        // backgroundColor: registrationUrl != ''
                        //     ? Colors.grey
                        //     : Colors.blue,
                        backgroundColor:
                            registrationUrl == '' && pickedFile == null
                            ? Colors.black
                            : registrationUrl == '' && pickedFile != null
                            ? Colors.blue
                            : Colors.red,
