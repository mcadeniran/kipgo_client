...
//   //           setState(() {
//   //             driverNumberPlate =
//   //                 (eventSnap.snapshot.value as Map)['numberPlate'].toString();
//   //           });
//   //         }
...
//   //           setState(() {
//   //             driverPhotoUrl =
//   //                 (eventSnap.snapshot.value as Map)['driverPhotoUrl']
//   //                     .toString();
//   //           });
//   //         }
...
//   //             setState(() {
//   //               driverRideStatus = AppLocalizations.of(
//   //                 context,
//   //               )!.driverHasArrived;
//   //             });
//   //           }
...
//             setState(() {
//               assignedDriverInfoContainerHeight = 0;
//               userRideRequestStatus = 'rejected';
//             });
...
//             final driverLoc = Map<String, dynamic>.from(data['driverLocation']);
//             final driverLatLng = LatLng(
//               double.parse(driverLoc['latitude'].toString()),
//               double.parse(driverLoc['longitude'].toString()),
//             );
...
//                 // Close this page and show ActiveRideWidget on home
//                 if (mounted) {
//                   Navigator.pop(context);

//                   // Tell Provider to switch to active ride
//                   Provider.of<AppInfo>(
//                     context,
//                     listen: false,
...
//                 break;
//               case 'ended':
//                 setState(() => assignedDriverInfoContainerHeight = 0);
//                 cleanupRideResources();
//                 if (mounted) {
//                   final assignedDriverId = data['driverId']?.toString() ?? '';
//                   String rideId = eventSnap.snapshot.key ?? '';
//                   // print("ASSIGNED DRIVER ID: $assignedDriverId");
//                   _endRide(context, assignedDriverId, rideId);
//                 }
//                 break;
//             }
//           }
...
//     setState(() {
//       searchingForDriversContainerHeight = 250;
//     });
//   }
...
//   void _endRide(BuildContext context, String driverId, String rideId) {
...
//             MaterialPageRoute(
//               builder: (context) =>
//                   userP.role == 'rider' ? CustomerHome() : DriverHome(),
//             ),
//             (route) => false,
//           );
//         },
